    ...
    <script type="text/javascript">
        ...
        function connect() {
            ...
            if ('WebSocket' in window) {
                ws= new WebSocket("ws://192.168.1.109:8082/mymvnweb/websck");
                console.log("ws://192.168.1.109:8082/mymvnweb/websck");
            }else {
                ws = new SockJS("http://192.168.1.109:8082/mymvnweb/sockjs/websck");
                console.log("http://192.168.1.109:8082/mymvnweb/sockjs/websck");
            }
